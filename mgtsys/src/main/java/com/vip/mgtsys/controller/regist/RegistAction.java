...
public class RegistAction {
	...
	public String doRegist(@RequestBody RegistInfo registInfo, HttpSession session) {
		...
		String newSid = formatter.format(dt).concat(String.format("%05d", sid+1));
		...
		EmployerInfo sessionEmployerInfo = new EmployerInfo();
		session.setAttribute(Constant.SESSION_EMPLOYER_INFO, sessionEmployerInfo);
